true.
 ...
 % Iteration: 1
[rook_protected([c(4,6,w,r),c(3,6,w,k),c(8,2,b,k)])]
[rook_protected([c(5,6,w,r),c(4,7,b,k),c(2,3,b,k)])]
Number of ex sampled 1 
[rook_protected([c(4,6,w,r),c(3,6,w,k),c(8,2,b,k)])]Initial number of facts 11 
Iteration 3 
...
% accuracy: 0.9833333333333333
 ...
 % Iteration: 2
[rook_protected([c(8,2,w,r),c(7,3,w,k),c(6,3,b,k)]),rook_protected([c(2,4,w,r),c(1,4,w,k),c(2,6,b,k)])]
[rook_protected([c(8,8,w,r),c(7,7,b,k),c(1,8,b,k)]),rook_protected([c(1,7,w,r),c(1,8,w,r),c(6,1,b,k)])]
Number of ex sampled 1 
[rook_protected([c(8,2,w,r),c(7,3,w,k),c(6,3,b,k)])]Initial number of facts 13 
Iteration 3 
Number of invented preds 12 
Iteration 2 
...
% accuracy: 0.8766666666666667
 ...
 % Iteration: 3
[rook_protected([c(1,7,w,r),c(2,8,w,k),c(5,7,b,k)]),rook_protected([c(4,6,w,r),c(3,6,w,k),c(1,4,b,k)]),rook_protected([c(2,8,w,r),c(2,7,w,k),c(2,6,b,k)]),rook_protected([c(1,4,w,r),c(1,5,w,k),c(3,7,b,k)])]
[rook_protected([c(7,3,w,r),c(8,3,w,r),c(5,3,b,k)]),rook_protected([c(8,7,w,r),c(7,8,w,r),c(8,5,b,k)]),rook_protected([c(7,4,w,r),c(6,4,w,r),c(1,6,b,k)]),rook_protected([c(7,2,w,r),c(6,2,w,r),c(5,7,b,k)])]
Number of ex sampled 1 
[rook_protected([c(1,7,w,r),c(2,8,w,k),c(5,7,b,k)])]Initial number of facts 11 
Iteration 3 
Number of invented preds 9 
Iteration 2 
Number of invented preds 3 
...
% accuracy: 0.74
 ...
 % Iteration: 4
[rook_protected([c(4,2,w,r),c(3,3,w,k),c(6,6,b,k)]),rook_protected([c(6,5,w,r),c(7,5,w,k),c(2,7,b,k)]),rook_protected([c(2,8,w,r),c(3,7,w,k),c(2,5,b,k)]),rook_protected([c(2,2,w,r),c(1,3,w,k),c(7,4,b,k)]),rook_protected([c(4,6,w,r),c(5,5,w,k),c(3,1,b,k)]),rook_protected([c(2,2,w,r),c(3,3,w,k),c(5,8,b,k)]),rook_protected([c(5,1,w,r),c(4,2,w,k),c(3,7,b,k)]),rook_protected([c(2,8,w,r),c(3,8,w,k),c(4,8,b,k)])]
[rook_protected([c(6,2,w,r),c(4,1,w,k),c(2,8,b,k)]),rook_protected([c(2,5,w,r),c(3,3,w,k),c(7,5,b,k)]),rook_protected([c(4,4,w,r),c(2,5,w,k),c(1,8,b,k)]),rook_protected([c(4,4,w,r),c(4,5,w,r),c(6,2,b,k)]),rook_protected([c(1,8,w,r),c(2,7,b,k),c(6,3,b,k)]),rook_protected([c(2,1,w,r),c(1,2,b,k),c(3,6,b,k)]),rook_protected([c(3,5,w,r),c(3,7,w,k),c(3,8,b,k)]),rook_protected([c(2,8,w,r),c(2,7,w,r),c(1,8,b,k)])]
Number of ex sampled 1 
[rook_protected([c(4,2,w,r),c(3,3,w,k),c(6,6,b,k)])]Initial number of facts 11 
Iteration 3 
Number of invented preds 9 
Iteration 2 
Number of invented preds 3 
...
% accuracy: 1
 ...
 % Iteration: 5
[rook_protected([c(3,8,w,r),c(4,8,w,k),c(6,4,b,k)]),rook_protected([c(5,7,w,r),c(6,8,w,k),c(7,7,b,k)]),rook_protected([c(4,7,w,r),c(5,6,w,k),c(4,6,b,k)]),rook_protected([c(3,2,w,r),c(2,2,w,k),c(4,1,b,k)]),rook_protected([c(8,3,w,r),c(8,2,w,k),c(6,6,b,k)]),rook_protected([c(6,5,w,r),c(5,4,w,k),c(2,7,b,k)]),rook_protected([c(6,2,w,r),c(6,1,w,k),c(6,5,b,k)]),rook_protected([c(7,4,w,r),c(6,3,w,k),c(5,4,b,k)]),rook_protected([c(8,4,w,r),c(8,3,w,k),c(6,8,b,k)]),rook_protected([c(6,1,w,r),c(5,2,w,k),c(8,7,b,k)]),rook_protected([c(6,3,w,r),c(7,2,w,k),c(2,2,b,k)]),rook_protected([c(5,3,w,r),c(5,4,w,k),c(6,4,b,k)]),rook_protected([c(7,4,w,r),c(8,3,w,k),c(4,4,b,k)]),rook_protected([c(7,2,w,r),c(8,3,w,k),c(4,7,b,k)]),rook_protected([c(3,2,w,r),c(4,3,w,k),c(2,8,b,k)]),rook_protected([c(6,8,w,r),c(5,8,w,k),c(8,7,b,k)])]
[rook_protected([c(2,8,w,r),c(1,8,b,k),c(6,3,b,k)]),rook_protected([c(6,3,w,r),c(7,3,w,r),c(2,8,b,k)]),rook_protected([c(4,2,w,r),c(5,4,w,k),c(5,7,b,k)]),rook_protected([c(6,6,w,r),c(6,5,w,r),c(3,6,b,k)]),rook_protected([c(8,1,w,r),c(7,2,w,r),c(5,4,b,k)]),rook_protected([c(8,1,w,r),c(7,3,w,k),c(4,4,b,k)]),rook_protected([c(3,3,w,r),c(2,2,w,r),c(6,5,b,k)]),rook_protected([c(5,4,w,r),c(6,3,b,k),c(8,4,b,k)]),rook_protected([c(5,7,w,r),c(4,6,w,r),c(3,7,b,k)]),rook_protected([c(3,5,w,r),c(2,7,w,k),c(8,3,b,k)]),rook_protected([c(1,2,w,r),c(1,3,b,k),c(6,3,b,k)]),rook_protected([c(7,6,w,r),c(7,7,b,k),c(7,5,b,k)]),rook_protected([c(4,6,w,r),c(5,7,b,k),c(8,2,b,k)]),rook_protected([c(3,4,w,r),c(4,6,w,k),c(3,2,b,k)]),rook_protected([c(8,1,w,r),c(7,2,w,r),c(7,8,b,k)]),rook_protected([c(2,8,w,r),c(2,7,b,k),c(3,6,b,k)])]
Number of ex sampled 1 
