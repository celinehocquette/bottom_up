true.
 ...
 % Iteration: 1
[rook_protected([c(6,3,w,r),c(7,4,w,k),c(7,7,b,k)])]
[rook_protected([c(1,2,w,r),c(1,3,b,k),c(5,8,b,k)])]
% learning rook_protected/1
% clauses top-down: 1
% clauses top-down: 2
% clauses top-down: 3
% time: 0.0022361278533935547
...
% accuracy: 0.88
 ...
 % Iteration: 2
[rook_protected([c(1,4,w,r),c(1,3,w,k),c(3,1,b,k)]),rook_protected([c(8,2,w,r),c(7,1,w,k),c(3,5,b,k)])]
[rook_protected([c(1,3,w,r),c(2,3,b,k),c(3,7,b,k)]),rook_protected([c(7,5,w,r),c(8,6,w,r),c(8,1,b,k)])]
% learning rook_protected/1
% clauses top-down: 1
% clauses top-down: 2
% clauses top-down: 3
% time: 0.0031371116638183594
rook_protected(A):-piece(A,B),rook_protected_1(A,B).
rook_protected_1(A,B):-piece(A,B),rook_protected_2(B).
rook_protected_2(A):-king(A),white(A).
% score pos: 150
...
% accuracy: 0.8533333333333334
 ...
 % Iteration: 3
[rook_protected([c(1,3,w,r),c(2,4,w,k),c(6,4,b,k)]),rook_protected([c(7,2,w,r),c(6,2,w,k),c(7,8,b,k)]),rook_protected([c(4,7,w,r),c(3,7,w,k),c(1,1,b,k)]),rook_protected([c(1,7,w,r),c(1,8,w,k),c(2,3,b,k)])]
[rook_protected([c(3,5,w,r),c(4,4,b,k),c(2,5,b,k)]),rook_protected([c(2,5,w,r),c(3,4,b,k),c(8,8,b,k)]),rook_protected([c(2,5,w,r),c(1,4,w,r),c(6,1,b,k)]),rook_protected([c(2,2,w,r),c(1,3,w,r),c(7,5,b,k)])]
% learning rook_protected/1
% clauses top-down: 1
% clauses top-down: 2
% clauses top-down: 3
% time: 0.005623817443847656
rook_protected(A):-piece(A,B),rook_protected_1(A,B).
rook_protected_1(A,B):-piece(A,B),rook_protected_2(B).
rook_protected_2(A):-king(A),white(A).
% score pos: 150
